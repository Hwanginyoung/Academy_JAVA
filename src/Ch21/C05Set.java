...
class Person {
	...
	public boolean equals(Object obj) {
		if(obj instanceof Person) {
			Person down = obj;
			this.name.equals(down.name) && this.addr.equals(down.addr);
		}
		return false;
	}
	...
	@Override
	public int hashCode() {
		//멤버의 name, addr 각각의 저장된 문자열을 문자로 쪼갠다음 문자를 숫자로 바꾸고 더한 후 저장
		int n1=0;
		int n2=0;
		//name을 숫자로 변환
...
//		Person t1 = new Person("홍길동", "대구");
//		Person t2 = new Person("홍길동", "대구");
//		Person t3 = new Person("강남구", "서울");
