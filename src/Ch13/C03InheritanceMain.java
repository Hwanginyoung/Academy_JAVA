...
class C03Super {
	int x;
	int y;
	C03Super(){System.out.println("C03Super() 생성자 호출")}
	C03Super(int x) {
		this.x=x;
		System.out.println("C03Super(int x) 생성자 호출")
	}
	C03Super(int y) {
		this.y=y;
		System.out.println("C03Super(int y) 생성자 호출")
	}
}
...
public class C03InheritanceMain {
	public static void main(String[] args) {
		...
		C03Sub ob1 = new C03Sub();System.out.println();
		ob1.ShowXYZ();System.out.println();
		C03Sub ob2 = new C03Sub(10);System.out.println();
		ob2.ShowXYZ();System.out.println();
		C03Sub ob3 = new C03Sub(10,20);System.out.println();
		ob3.ShowXYZ();System.out.println();
		C03Sub ob4 = new C03Sub(10,20,30);System.out.println();
