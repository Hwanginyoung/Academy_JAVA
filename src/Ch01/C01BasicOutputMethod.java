...
//		System.out.print("동길동\t22\t네트워크전공\n");
//		System.out.print("남길동\t44\t정보보안\n");
...
//		System.out.printf("%d.s : %c\n", 1,"홍길동",'A');
		...
		//문제
		//서식문자를 이용해서 다음과 같은 문자를 완성하세요
		//나의 이름은 %s 입니다	   (%s에 본인 이름)
		//나의 나이는 %d살 입니다.  (%d에 본인 나이)
//		System.out.printf("나의 이름은 %s 입니다.\n", "황인영");
//		System.out.printf("나의 나이는 %d살 입니다.\n", 18);
